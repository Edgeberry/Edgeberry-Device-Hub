        ...
        <>
            ...
            <Offcanvas show={show} onHide={()=>{setShow(false)}} placement={'end'} style={{maxWidth:'300px'}}>
                ...
                <Offcanvas.Body style={{padding:'0px'}}>
                    <ListGroup>
                        <ListGroup.Item as={Link} to='/devices' onClick={()=>{setShow(false)}}>
                    ...
                    <Container className="container-bottom" style={{fontSize:'12px'}}>
                        <hr/>
                        <p>Edgeberry Fleet Hub is open-source software. The source code is available on the <a href={'https://github.com/Edgeberry/'} target={'_blank'}>Edgeberry GitHub</a>.</p>
                    </Container>
                </Offcanvas.Body>
            </Offcanvas>
        </>
